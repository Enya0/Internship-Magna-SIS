...
function ver_laboratorios(){
    ...
    echo '<table bgcolor="#FFFFFF"><tr><th>'. obtenerTraduccion("imagenes") .'</th><th>'. obtenerTraduccion("laboratorios") .'</th><th>'. obtenerTraduccion("puestos") .'</th><th>'. obtenerTraduccion("ver") .'</th></tr>';
    ...
    foreach ($results as $result) {
        ...
        foreach ($results_hardware as $result_hardware) {
            ...
            echo '</td><td style="text-align: center;" width="50%">';
            if ($idioma == "eu") {
